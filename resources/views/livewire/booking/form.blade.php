        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror " name="nama" placeholder="asep" wire:model="nama">
                    @error('nama')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('noTelp') is-invalid @enderror" wire:model="noTelp" maxlength="16" oninput="formatNomorHP(this)"
                        placeholder="08xx" >
                    @error('noTelp')
                    <small id="emailHelp" class="form-text text-muted text-danger">{{$message}}</small>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal') is-invalid  @enderror" name="tanggal" wire:model="tanggal"
