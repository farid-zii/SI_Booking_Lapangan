...
<head>
    ...
    <link rel="stylesheet" href="landingPage/css/bootstrap-icons.css">
    ...
    <link href="landingPage/css/templatemo-pod-talk.css" rel="stylesheet">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand me-lg-5 me-0" href="index.html">
                    <img src="landingPage/logo.png" class="logo-image img-fluid" alt="templatemo pod talk">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/informasi">Jadwal</a>
                        </li>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="site-footer-thumb mb-4 pb-2">
                        <div class="d-flex flex-wrap">
                            <a href="#">
                                <img src="landingPage/images/app-store.png" class="me-3 mb-2 mb-lg-0 img-fluid" alt="">
                            </a>

                            <a href="#">
                                <img src="landingPage/images/play-store.png" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
